  ...
  return (
    <section className="px-6 py-24">
      <div className="mx-auto max-w-[1200px] rounded-[24px] border border-white/[0.08] bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.14),rgba(255,255,255,0.04)_42%,rgba(13,13,13,1)_100%)] px-6 py-16 text-center md:px-12">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-white/38">Start with one ad</p>
        <h2 className="mt-4 text-4xl font-medium tracking-[-0.04em] text-white md:text-6xl">Need a good product ad fast?</h2>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-white/60">
          Send one product brief. We will help turn it into a short-form ad creative you can test quickly, then upgrade the winners into more polished versions.
        </p>
