    ...
    <section className="mx-auto max-w-[1200px] px-6 pb-16">
      <div className="grid gap-6 rounded-[28px] border border-white/[0.08] bg-[#0d0d0d] p-7 md:p-9 lg:grid-cols-[1fr_0.9fr] lg:items-center">
        <div>
          ...
          <h2 className="mt-4 text-3xl font-medium tracking-[-0.04em] text-white md:text-5xl">Get a free creative review before you remake it.</h2>
          <p className="mt-5 max-w-2xl text-base leading-7 text-white/56">
            Paste your current ad or video link. Get a quick review on hook, product clarity, pacing and CTA. This is for existing ads, not a performance prediction.
          </p>
